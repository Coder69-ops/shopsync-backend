import { Controller, Post, Headers, HttpCode, HttpStatus, Logger, UnauthorizedException, RawBodyRequest, Req, Inject, forwardRef } from '@nestjs/common';
...
export class ShopifyWebhookController {
    ...
    async handleShopifyWebhook(
        ...
        this.logger.log(`Received Shopify webhook: Topic=${topic} from Shop=${shopDomain}`);
