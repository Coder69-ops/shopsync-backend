import { PrismaClient, ProductType, SubscriptionPlan, UserRole } from '@prisma/client';
...
async function main() {
        ...
        shop = await prisma.shop.create({
            data: {
                ...
                aiConfig: {
                    ...
                    useEmojis: true,
                    greeting: 'Welcome to ShopSync! I am your AI assistant. How can I help you automate your business today?',
                    outOfStockMessage: 'This service is currently reaching capacity. Please check back soon!'
                }
            }
        });
    }
    ...
    const csvPath = fs.existsSync(path.resolve(process.cwd(), 'shopsync_digital_products.csv'))
    ...
    const jsonPath = fs.existsSync(path.resolve(process.cwd(), 'shopsync_knowledgebase.json'))
